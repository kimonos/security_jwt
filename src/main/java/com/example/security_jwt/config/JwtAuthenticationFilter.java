...
public class JwtAuthenticationFilter extends OncePerRequestFilter { //確保單一請求的執行緒只會被呼叫一次
    ...
    protected void doFilterInternal(
        ...
        final String authHeader = request.getHeader("Authorization");//設定一個字串變數authHeader來儲存"Authenication"標頭的值
        final String jwt;
